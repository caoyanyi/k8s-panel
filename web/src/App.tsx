...
function readRoute(): RouteName {
  ...
  return ['dashboard', 'clusters', 'resources', 'workloads', 'network', 'configuration', 'storage', 'governance', 'security', 'access', 'events', 'helm', 'operations', 'audit'].includes(candidate) ? candidate : 'dashboard'
}
