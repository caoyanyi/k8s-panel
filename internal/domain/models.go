...
type KubernetesDisruptionBudgetStatus string

const (
	DisruptionBudgetAvailable  KubernetesDisruptionBudgetStatus = "available"
	DisruptionBudgetBlocked    KubernetesDisruptionBudgetStatus = "blocked"
	DisruptionBudgetInactive   KubernetesDisruptionBudgetStatus = "inactive"
	DisruptionBudgetUnobserved KubernetesDisruptionBudgetStatus = "unobserved"
)
...
type KubernetesPodDisruptionBudget struct {
	...
	Observed                            bool                             `json:"observed"`
	DisruptionStatus                    KubernetesDisruptionBudgetStatus `json:"disruption_status"`
